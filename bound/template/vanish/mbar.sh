...
#srun /home/finlayclark/anaconda3/envs/biosimspace-dev/bin/analyse_freenrg mbar -i output/lambda*/simfile.dat -p 95 --overlap --temperature 298.0 > freenrg-MBAR-p-95-overlap.dat
